...
},{"rx":24}],2:[function(require,module,exports){
"use strict";
...
},{"rx":24}],4:[function(require,module,exports){
'use strict';
...
},{"./fromevent":3,"./transposition":7,"./virtual-hyperscript":9,"matches-selector":21,"rx":24,"vdom-parser":29,"virtual-dom/diff":36,"virtual-dom/patch":37}],6:[function(require,module,exports){
"use strict";
...
},{"./transposition":7,"rx":24,"vdom-to-html":33}],7:[function(require,module,exports){
"use strict";
...
},{"rx":24,"virtual-dom/vnode/vnode":56}],8:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":9,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":44,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":48,"x-is-array":61}],9:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
},{"min-document":10}],15:[function(require,module,exports){
/**
...
},{"sentence-case":25}],23:[function(require,module,exports){
...
},{"./vendor/camel-case-regexp":26,"./vendor/non-word-regexp":27,"./vendor/trailing-digit-regexp":28,"lower-case":20}],26:[function(require,module,exports){
...
},{"./property-config":34,"escape-html":12}],33:[function(require,module,exports){
var escape = require('escape-html');
...
},{"../vnode/is-vhook.js":51,"is-object":19}],39:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":49,"../vnode/is-vnode.js":52,"../vnode/is-vtext.js":53,"../vnode/is-widget.js":54,"./apply-properties":38,"global/document":14}],40:[function(require,module,exports){
...
},{"./create-element":39,"./dom-index":40,"./patch-op":41,"global/document":14,"x-is-array":61}],43:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":13}],46:[function(require,module,exports){
'use strict';
...
},{"browser-split":11}],48:[function(require,module,exports){
'use strict';
...
},{"../vnode/is-vhook":51,"is-object":19}],60:[function(require,module,exports){
var isArray = require("x-is-array")
...
// factory functions need to be mad for makeLink and makeNode
function makeLink(oldLink) {
  return {
    sourceName: oldLink.source,
    targetName: oldLink.target,
    source: 0,
    target: 0,
    d: '',
    x0: 0,
...
function e2a(edgeCollection) {
  var source = arguments.length <= 1 || arguments[1] === undefined ? 'source' : arguments[1];
  var target = arguments.length <= 2 || arguments[2] === undefined ? 'target' : arguments[2];

  var nodes = new Array(),
      links = new Array(edgeCollection.length),
      nodeMap = new Map(),
  ...
  edgeCollection.forEach(function (link) {
    var newLink = makeLink(link);

    while (counter < 2) {
      var key = link[by[counter]];
    ...
    while (counter < 2) {
      nodeIndex = newLink[by[counter]];

      if (nodes.length <= nodeIndex) {
        var newNode = makeNode(link[by[counter]]);

        newNode[to[counter]].push(linkIndex);
        nodes.push(newNode);
      } else {
        nodes[nodeIndex][to[counter]].push(linkIndex);
      }
      counter++;
    }
...
exports.adjacencyLists = undefined;

var _sumNodeValues = require('./sumNodeValues');

var _e2a = require('./e2a');

// delete this later......

// © 2016 James Haley for licencing contact at james.r.haley@gmail.com
function adjacencyLists(data, soureAndTarget) {

    var graph = (0, _e2a.e2a)(data);

    graph = (0, _sumNodeValues.sumNodeValues)(graph.nodes, graph.links);
    return graph;
    // for better understanding what is happening use this
    // return deepcopy(graph)
}

exports.adjacencyLists = adjacencyLists;

},{"./e2a":63,"./sumNodeValues":65}],65:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sumNodeValues = undefined;
...
* links.
*/
// need a way to get all values and sum them and this should be
// done durring the gathering

// source target doesn't matter
function sumNodeValues(allNodes, allLinks) {
  var getValue = function getValue(link) {
    return link.value;
  };
  ...
  while (++i < len) {
    var node = allNodes[i];
    node.value = Math.max((0, _sharedResource.sum)((0, _sharedResource.indexed)(node.source, allLinks, getValue)), (0, _sharedResource.sum)((0, _sharedResource.indexed)(node.target, allLinks, getValue)));
  }
...
var gz = _interopRequireWildcard(_grizzy);

var _model = require('./adjacencyModel/model');
...
function modelData(dataStream, flatten) {
    ...
    var graph = (0, _model.adjacencyLists)(dataStream, ["source", "target"]);

    var sankey = new _Sankey.Sankey({ nodes: graph.nodes, links: graph.links });
    sankey.nodeWidth(42).nodePadding(flatten).size([SIZE.width, SIZE.height]).curvature(0).compare(function (a, b) {
...
function update(parentObject, sankeyModel) {
    ...
    (0, _shapes.makeLink)(parentObject, sankeyModel, SIZE.width);

    (0, _shapes.makeRects)(parentObject, sankeyModel);

    (0, _shapes.makeLabel)(parentObject, sankeyModel, SIZE.width);
}

function program(data, flatten) {
    update(svg, modelData(data, flatten));
}
...
var request$ = Observable.create(function (observer) {
    ...
    return each.map(function (record) {
        ...
        return {
            ...
            source: record.field,
            n: +record.n,
            target: record.occupation
        };
    });
});
//swap----------------------------------------------------
// const swapButton = pick('.swap')
// const swap$ = Observable.fromEvent(swapButton, 'click')
//     .startWith(null)
//     .flatMap((x)=>{
//         console.log(x);
//         if (x === null) {
...
var BASE_SLIDER_INPUT = {
    low: BASE_LOW,
    high: BASE_HIGH
};

var BASE_MOUSEDOWN_INPUT = {
    node: null,
    value: null
};
...
var mousedown$ = Observable.fromEvent(mouseClick, 'mousedown', function (evt) {
...
//base state--------------------------------------------------------
// filters to be used in the program
var firstFilter = function firstFilter(x, value) {
    return true;
};
var rectFilter = function rectFilter(e, value) {
    return e.source === value.name || e.target === value.name;
};

var linkFilter = function linkFilter(e, value) {
    return e.source === value.sourceName || e.target === value.sourceName || e.source === value.targetName || e.target === value.targetName;
};

var state$ = Observable.combineLatest(interaction$, request$, function (interaction, data) {

    var slider = interaction[0];
    var mouse = interaction[1];
...
function view(state$) {
  return state$.map(function (state) {
    return (0, _dom.div)([(0, _dom.div)('.filterbox', [(0, _dom.label)('Low Edge Filter: '), (0, _dom.input)('.lowSlider', {
      ...
      max: 665238,
      value: state.high
    }), (0, _dom.input)('.highInput', { value: state.high })]), (0, _dom.h4)('.rangePhrase', 'Total Range of weights spans between ' + state.low + ' to ' + state.high), (0, _dom.p)('Edges consist of groups of people and links represent those edges as students transition from college to career.')]);
  });
}
// let exit$ = intent(sources.DOM);
...
// import { sumNodeValues } from './sumNodeValues';
...
var _nodeBreadths = require('./nodeBreadths');

var _depthsNodeAndLink = require('./depthsNodeAndLink');

var _linkXandY = require('./linkXandY');

var _renderLinksDAttr = require('./renderLinksDAttr');

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

/**
* Sankey : As of right now any part of this module that dealt with
* with build a data model has been remove.  only cordinate mapping
* remains.
* @param{Number} (__nodeWidth__) -> witdth of nodes
* @param{Number} (__nodePadding__) -> space top/bottom of nodes/links
* @param{Array::Numbers} (__size__) -> array of width & height
* @param{Array::Objects} (__nodes__) -> array of node objects
* @param{Array::Objects} (__links__) -> array of link objects
* @param{Number?float} (__curvature__) -> curve amount of the links
// TODO compare needs to be an array or function
* @param{Function} (__compare__) -> comparison for sorting
*/
...
var Sankey = function () {
  function Sankey(graph) {
    ...
    this.__nodes__ = graph.nodes, this.__links__ = graph.links, this.__empty__ = [], this.__nodeWidth__ = 24, this.__nodePadding__ = 8, this.__size__ = [1, 1], this.__curvature__ = .5, this.__compare__ = function (a, b) {
      return a.y - b.y;
    };
  }
  ...
  _createClass(Sankey, [{
    key: 'nodeWidth',
    value: function nodeWidth(width) {
      if (!arguments.length) {
        return this.__nodeWidth__;
      } else {
    ...
    key: 'nodePadding',
    value: function nodePadding(padding) {
      if (!arguments.length) {
        return this.__nodePadding__;
      } else {
        this.__nodePadding__ = +padding;
        return this;
      }
    }
  }, {
    key: 'nodes',
    value: function nodes(array) {
      if (!arguments.length) {
        return this.__nodes__;
      } else {
        this.__nodes__ = array;
        return this;
      }
    }
  }, {
    key: 'links',
    value: function links(array) {
      if (!arguments.length) {
        return this.__links__;
      } else {
        this.__links__ = array;
        return this;
      }
    }
  }, {
    key: 'size',
    value: function size(array) {
      if (!arguments.length) {
    ...
    // needs to accept and array or a function
    value: function compare(option) {
      if (!arguments.length) {
        return this.__compare__;
      } else {
        this.__compare__ = option;
        return this;
      }
    }
  }, {
    key: 'curvature',
    value: function curvature(number) {
      if (!arguments.length) {
        return this.__curvature__;
      } else {
        this.__curvature__ = +number;
        return this;
      }
    }
  }, {
    key: 'emptySet',
    value: function emptySet(object) {
      if (!arguments.length) {
        return this.__empty__;
      } else {
        if (object.hasOwnProperty('empty')) {
          this.__empty__[0] = object;
        } else {
          this.__empty__ = [];
        }
        return this;
    ...
    key: 'layout',
    value: function layout(iterations) {
      var nodes = this.nodes(),
          links = this.links(),
          width = this.nodeWidth(),
          size = this.size(),
          padd = this.nodePadding(),
          comp = this.compare(),
          curve = this.curvature();

      var nodeScaled = (0, _nodeBreadths.nodeBreadths)(nodes, links, width, size[0]);
      // bad name because I need to figure out how to seperate this
      var finalNodes = (0, _depthsNodeAndLink.depthsNodeAndScaleLinkAndNode)(nodeScaled, links, size, padd, comp);
      var linkScaled = (0, _linkXandY.linkXandY)(links, finalNodes, width);
      var finalLinks = (0, _renderLinksDAttr.renderLinksDAttr)(linkScaled, curve);

      if (finalNodes.length === 0) {
        this.emptySet({ text: 'no results', id: 'emptySet', empty: true });
      } else {
        this.emptySet({ text: 'no results', id: 'emptySet', empty: false });
      }
...
exports.breadthFirstLayout = undefined;

var _sharedResource = require('../helpers/sharedResource');

/**
* adjacent -> grab adjacent nodes through links
* @param{Object} (root) -> root node
* @param{Object::Arrays} (graph) -> contains links/nodes arrays
* @param{String} (target) -> what direction to be searching
* @return{Array::Objects} -> collection of nodes
*/
function adjacent(root, graph) {
  var target = arguments.length <= 2 || arguments[2] === undefined ? 'target' : arguments[2];

  var linkList = graph.links,
      nodeList = graph.nodes,
      nodes = new Array(),
      adjacentIndices = root[target],
      links = (0, _sharedResource.indexed)(adjacentIndices, linkList);

  links.forEach(function (link) {
    nodes.push(nodeList[link[target]]);
  });
...
/**
* bfsMethod -> performs a bfs search and apply x values for columns
* @param{Object::Arrays} (graph) -> contains links/nodes arrays
* @param{Object} (root) -> root node
* @param{String} (target) -> what direction to be searching
* @param{Object::Number} (columns) -> how many columns
*/
// © 2016 James Haley for licencing contact at james.r.haley@gmail.com
function bfsMethod(graph, root, target, columns) {
  ...
  var _loop = function _loop() {
    ...
    var adj = adjacent(pointer, graph, target);
...
/**
* breadthFirstLayout -> create a sankey layout by finding the 
*   ordering of all element and assigning that order to the x cord
* @param{Object::Arrays} (graph) -> contains links/nodes arrays
* @param{String} (target[default:'target']) -> direction of traversal
* @return{Object::Arrays&Number} 
*/
function breadthFirstLayout(graph) {
  var target = arguments.length <= 1 || arguments[1] === undefined ? 'target' : arguments[1];

  // width is passing reference to bfsMethod to get a side effect  
  var columns = { 0: 0 };

  graph.nodes.forEach(function (node) {
    if (node.visted === false) {
      var root = node;
      bfsMethod(graph, root, target, columns);
    }
  });

  return { nodes: graph.nodes, links: graph.links, width: columns[0] };
}
...
exports.depthsNodeAndScaleLinkAndNode = undefined;
...
/**
* scaleNodesANDLinks
* dy is the only thing that schould be done in this function
* that way they can be sorted based off of value and then have their
* y possition added
*/

function scaleNodesANDLinks(nodesByBreadth, allLinks, height, padding, compare) {
  var byValue = function byValue(link) {
    return link.value;
  };
  var scalar = (0, _sharedResource.min)(nodesByBreadth, function (breadth) {
    return (height - (breadth.length - 1) * padding) / (0, _sharedResource.sum)(breadth, byValue);
  });

  nodesByBreadth.forEach(function (nodes) {
    // sort the nodes based off of user need
    nodes.sort(compare);

    nodes.forEach(function (node) {
      // bring value to scale
      node.dy = node.value * scalar;
    });
  });

  allLinks.forEach(function (link) {
    // bring value to scale
    link.dy = link.value * scalar;
  });
}
...
// © 2016 James Haley for licencing contact at james.r.haley@gmail.com
function computeNodeY(nodesByBreadth, height, padding) {
  nodesByBreadth.forEach(function (nodes) {
    var node = undefined,
        nextY = 0,
        count = nodes.length,
    ...
    for (i = 0; i < count; ++i) {
      ...
      nextY = node.y + node.dy + padding;
    }
  });
}

/**
*depthsNodeAndScaleLinkAndNode
* @param{Array::Objects} (allNodes) -> collections of nodes
* @param{Array::Objects} (allLinks) -> collection of links
* @param{Array::Numbers} (dimensions) -> array of width & height
* @param{Number} (padding) -> padding for bottom of links
* @param{Function} (compare) -> function for sorting nodes
*/

function depthsNodeAndScaleLinkAndNode(allNodes, allLinks, dimensions, padding, compare) {
  var nodesByBreadth = (0, _sharedResource.d3nest)().key(function (d) {
    return d.x;
  }).sortKeys(_sharedResource.ascending).entries(allNodes).map(function (d) {
    return d.values;
  });

  var height = dimensions[1];

  scaleNodesANDLinks(nodesByBreadth, allLinks, height, padding, compare);
  computeNodeY(nodesByBreadth, height, padding);
  return allNodes;
}
...
exports.linkXandY = undefined;

var _sharedResource = require('../helpers/sharedResource');

/**
* linkXandY
* @param{Array::Objects} (allNodes) -> collection of nodes 
* @param{Array::Objects} (allLinks) -> collection of links
* @param{Number} (nodeWidth) -> width of nodes for finding cords
* the point of linkXandY it to go through all of the Nodes
* and apply sy and ty to all of its corisponding links.
* The function operates like a groupby function where each group
* of edges of a parent nodeis sorted in assending order and y cords
* start at node.y then each sequential it that plus each link.dy
*
* TODO make sorting customizable
*/
// source target doesn't matters
function linkXandY(allLinks, allNodes, nodeWidth) {
  var ascend = function ascend(a, b) {
    return b.dy - a.dy;
  };
  // need a better solution for knowing y of source node
  allNodes.forEach(function (node) {
    var sy = 0 + node.y,
        ty = 0 + node.y,
        x0 = node.x + nodeWidth,
        x1 = node.x,
        linksFromNodeTargets = (0, _sharedResource.indexed)(node.target, allLinks),
        linksFromNodeSource = (0, _sharedResource.indexed)(node.source, allLinks);

    linksFromNodeTargets.sort(ascend).forEach(function (link) {
      link.sy = sy;
      sy += link.dy;
      link.x0 = x0;
    });

    linksFromNodeSource.sort(ascend).forEach(function (link) {
      link.ty = ty;
      ty += link.dy;
      link.x1 = x1;
    });
...
exports.nodeBreadths = undefined;

var _sharedResource = require('../helpers/sharedResource');

var _breadthFirstLayout = require('./breadthFirstLayout');

// © 2016 James Haley for licencing contact at james.r.haley@gmail.com

var scaleNodeBreadths = function scaleNodeBreadths(allNodes, nodeWidth, kx) {
  allNodes.forEach(function (node) {
    node.x *= kx;
    node.dx = nodeWidth;
    // console.log(node.x);
...
* @param{Array::Numbers} (dimensions) -> array of width[0], height[1]
* Iteratively assign the breadth (x-position) for each node.
* Nodes are assigned the maximum breadth of incoming neighbors 
* plus one;
* nodes with no incoming links are assigned breadth zero, while
* nodes with no outgoing links are assigned the maximum breadth.
*
* basically, pusts the x value on the node
*/
// source target matters
function nodeBreadths(allNodes, allLinks, nodeWidth, chartWidth) {

  var graph = { nodes: allNodes, links: allLinks };

  var solved = (0, _breadthFirstLayout.breadthFirstLayout)(graph);
  var kx = (chartWidth - nodeWidth) / solved.width;

  var scaledNodes = scaleNodeBreadths(solved.nodes, nodeWidth, kx);
...
var dCurved = function dCurved(d, curve) {
    var x0 = d.x0,
        x1 = d.x1,
        dy = d.dy,
        setControlPoint = interpolateNumber(x0, x1),
        cx1 = setControlPoint(curve),
        cx2 = setControlPoint(1 - curve),
        y0 = d.sy,
        y1 = d.ty,
        y12 = y1 + dy,
        y02 = y0 + dy;
    return "M " + x0 + "," + y0 + " C " + cx1 + "," + y0 + " " + cx2 + "," + y1 + " " + x1 + " " + y1 + " V " + y12 + " C " + cx2 + "," + y12 + " " + cx1 + "," + y02 + " " + x0 + " " + y02 + " Z";
};

var dlinear = function dlinear(d, curve) {
    var x0 = d.x0,
        x1 = d.x1,
        dy = d.dy,
        y0 = d.sy,
        ...
        y12 = y1 + dy,
        y02 = y0 + dy;
    return "M " + x0 + "," + y0 + " L " + x1 + ", " + y1 + " L " + x1 + ", " + y12 + " L " + x0 + " " + y02 + " Z";
};

function renderLinksDAttr(alllinks, curve) {
    // alllinks.forEach( link => {
    //     link.d = renderString(link, curve);
    // });
    var func = dCurved,
        len = alllinks.length,
        i = undefined;
...
function makeLabel(parentObject, sankeyModel, width) {
  ...
  var pad = sankeyModel.nodePadding();
  ...
  var labels = draw("text", parentObject, {
    data: [sankeyModel.nodes(), function (d) {
      return d.name + 1;
    }],
    is: {
      preUpdate: function preUpdate(selection) {
        return selection.transition().duration(durationLable).attr('y', function (d) {
          return d.y + d.dy / 2;
        }).style({
          "fill-opacity": 1,
          "font-size": fontSize
      ...
      enter: function enter(selection) {
        return selection.enter().append("text").style("fill-opacity", 1e-6).attr({
          "class": "label",
          "dy": ".35em",
          // this could already be done
          // but would need to be in the settings
          "text-anchor": "end",
          "font-size": fontSize,
          // this could be a transform translate
          // if these two things could be done then
          // i can get rid of shiftLablesRight 
          'y': function y(d) {
            return d.y + d.dy / 2;
          },
          'x': function x(d) {
          ...
          return d.name;
        }).transition().duration(OFFSET).delay(durationLable).style("fill-opacity", 1);
      },
      shiftLablesRight: function shiftLablesRight(selection) {
  ...
  durationLable = MAIN_TRANSITION_TIME;

  return labels;
}

// object to make an empty set
...
function makeLink(parentObject, sankeyModel) {
  var strokeWidth = function strokeWidth(d) {
    return 1;
  };

  return draw(".link", parentObject, {
    data: [sankeyModel.links(), function (d) {
      return d.sourceName + "-" + d.targetName;
    }],
    is: {
      preUpdate: function preUpdate(selection) {
        return selection.transition().duration(duration).attr("d", function (d) {
          return d.d;
        }).style({
      ...
      enter: function enter(selection) {
        return selection.enter().append("path").attr({ "class": "link" }).style({
          "fill-opacity": 0,
          "fill": function fill(d) {
            return linkColor(d.diff);
          }
        }).transition().duration(OFFSET).delay(duration).style("fill-opacity", BASE_OPACITY).attr("d", function (d) {
          return d.d;
        }).sort(function (a, b) {
          return b.dy - a.dy;
        });
...
function makeRects(parentObject, sankeyModel) {
  // this could already be done
  var translateToString = function translateToString(d) {
    return "translate(" + d.x + "," + d.y + ")";
  };
  var setHeight = function setHeight(d) {
    return d.dy;
  };

  var node = draw(".node", parentObject, {
    data: [sankeyModel.nodes(), function (d) {
      return d.name;
    }],
    is: {
      preUpdate: function preUpdate(selection) {
        return selection.transition().duration(duration).attr({
      ...
      enter: function enter(selection) {
        var nodes = selection.enter().append("rect").attr({
          "class": "node",
          "transform": translateToString,
          "height": setHeight,
          ...
          "fill-opacity": 0,
          "stroke-opacity": 0
        }).transition().duration(OFFSET).delay(duration).style({
          "fill-opacity": 1,
          "stroke-opacity": 1
        });
  ...
  duration = MAIN_TRANSITION_TIME;

  return node;
}

exports.makeLink = makeLink;
exports.makeRects = makeRects;
